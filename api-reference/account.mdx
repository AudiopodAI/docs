...
<Columns cols={2}>
  ...
  <Card title="Credits Management" icon="credit-card" href="/api-reference/credits">
    Monitor and manage your credit balance and usage.
  </Card>
  <Card title="Voice Cloning" icon="user-clone" href="/api-reference/voice-cloning">
    Start creating custom voices with your account.
  </Card>
