...
|---------|------|-------------|
| AI Denoising | 5 credits/minute | Advanced neural network processing |
| Spectral Processing | 3 credits/minute | Traditional spectral subtraction |

### Cost Examples

| Duration | Method | Credits | USD Cost |
|----------|--------|---------|----------|
| 10 minutes | AI Denoising | 50 | $0.05 |
| 30 minutes | Spectral | 90 | $0.09 |
| 1 hour | AI Denoising | 300 | $0.30 |
...
<Columns cols={2}>
  ...
  <Card title="Speaker Extraction" icon="users" href="/api-reference/speaker-extraction">
    Better speaker separation with noise-free audio.
  </Card>
  <Card title="Media Extraction" icon="download" href="/api-reference/media-extraction">
    Extract high-quality audio from videos for processing.
  </Card>
</Columns>