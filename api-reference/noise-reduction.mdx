...
One rate card: a noise-reduction job costs the same from the dashboard as it
does through an API key. Session calls spend account credits; API-key calls
spend the API wallet, at the dollar value of the same credits ($1 = 7,500).

| Service | Quality mode | Credits | API wallet |
|---------|--------------|---------|------------|
| AI Denoising | `balanced` (default) | 150 credits/minute | $0.02/min |
| AI Denoising | `studio` | 300 credits/minute | $0.04/min |
| AI Denoising | `ultra` | 600 credits/minute | $0.08/min |
| Spectral Processing | — | 150 credits/minute | $0.02/min |

<Note>
  Spectral processing is billed at the same rate as balanced denoising — it is
  a lighter, non-AI method, and it is priced accordingly.
</Note>

### Cost Examples

| Duration | Method | Credits | API wallet |
|----------|--------|---------|------------|
| 10 minutes | AI Denoising (balanced) | 1,500 | $0.20 |
| 10 minutes | AI Denoising (studio) | 3,000 | $0.40 |
| 10 minutes | AI Denoising (ultra) | 6,000 | $0.80 |
| 30 minutes | Spectral | 4,500 | $0.60 |
| 1 hour | AI Denoising (balanced) | 9,000 | $1.20 |
