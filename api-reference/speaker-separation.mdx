...
|---------|------|-------------|
| Speaker Diarization | 1650 credits/minute | Identify when each speaker talks |
| Speaker Extraction | 1650 credits/minute | Generate separate audio files |

### Cost Examples

| Duration | Service | Credits | USD Cost |
|----------|---------|---------|----------|
| 10 minutes | Diarization | 16500 | $2.20 |
| 30 minutes | Extraction | 49500 | $6.60 |
| 1 hour | Both services | 198000 | $26.40 |
...
<Columns cols={2}>
  ...
  <Card title="AI Dubbing" icon="user-clone" href="/api-reference/ai-dubbing">
    Speech to Speech translation for any audio/video content
  </Card>
</Columns>