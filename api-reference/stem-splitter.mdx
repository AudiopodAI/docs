...
**Base rate:** $0.10 per minute of audio processed for every standard mode —
`single`, `two`, `four`, `six`, `producer`, `studio`, `mastering`.
...
|-----------|------------|----------------|
| Lead / backing vocal split (`lead_vocal`, `backing_vocal`) | **1.5×** | $0.15/min |
| Vocal gender split (`male_vocal`, `female_vocal`) | **1.5×** | $0.15/min |
| Single-instrument isolation from the 45-instrument catalog | **2.0×** | $0.20/min |
