...
<Columns cols={2}>
  ...
  <Card title="Voice Cloning" icon="user-clone" href="/api-reference/voice-cloning">
    Train voice models using extracted vocal stems.
  </Card>
  <Card title="Noise Reduction" icon="volume-x" href="/api-reference/noise-reduction">
    Clean up individual stems for better quality.
  </Card>
  <Card title="Karaoke Generation" icon="microphone" href="/api-reference/karaoke-generation">
    Create professional karaoke tracks with lyrics.
  </Card>
</Columns>