...
Text to Speech pricing is based on the number of characters in your input text:

- **0.5 credits per character** of input text
- Pricing is calculated on the character count before synthesis
...
| ----------- | ------------ | -------- |
| 100 characters | 50 credits | $0.007 |
| 500 characters | 250 credits | $0.033 |
| 1,000 characters | 500 credits | $0.067 |
| 5,000 characters | 2,500 credits | $0.33 |
