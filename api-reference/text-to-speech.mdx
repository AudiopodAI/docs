...
- `generation_params` (optional): JSON string of premium-voice controls — `delivery_mode`, `timestamp_type`, `text_normalization` (see [Delivery & timestamp controls](#delivery-timestamp-controls))
