...
AudioPod AI's Voice Generation service provides unified text-to-speech capabilities for both **standard pre-built voices** and **custom voice clones**. Using state of the art Text to Speech Models, generate speech with any voice in 60+ supported languages.
...
Voice generation pricing is based on audio duration:
