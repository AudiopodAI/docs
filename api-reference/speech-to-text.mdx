...
transcript. Talk to us at [support@audiopod.ai](mailto:support@audiopod.ai) if
you need the streaming protocol for your integration.
...
<Columns cols={2}>
  <Card title="Text to Speech" icon="waveform-lines" href="/api-reference/text-to-speech">
    Turn text into speech with a catalog or cloned voice.
  </Card>
