...
|---------|------|-------------|
| Basic Transcription | 10 credits/minute | Text-only transcription |
| With Speaker Diarization | 12 credits/minute | Speaker identification included |
| With Word Timestamps | +2 credits/minute | Word-level timing data |
...
|----------|----------|---------|----------|
| 10 minutes | Basic transcription | 100 | $0.10 |
| 30 minutes | With speakers + timestamps | 420 | $0.42 |
| 1 hour | Full features | 840 | $0.84 |
| 2 hours | Full features | 1,680 | $1.68 |
...
<Columns cols={2}>
  ...
  <Card title="Voice Cloning" icon="user-clone" href="/api-reference/voice-cloning">
    Create custom voices from transcribed speech samples.
  </Card>
