...
The easiest way to generate music. Describe what you want in natural language and AudioMusic V2's 4B Language Model automatically generates the caption, lyrics, BPM, key, time signature, and duration.
...
The 4B Language Model uses Chain-of-Thought reasoning to automatically:
