---
title: "Audio AI Platform for Developers"
description: "AI-powered audio processing APIs. Audiobook production, stem separation, transcription, voice cloning, music generation, and more."
---
...
Prefer to click rather than type? Fork the **Getting Started** collection and hit
a real `200` in two requests — no account, no API key
([what's in it](/sdks/postman)).

[![Run in Postman](https://run.pstmn.io/button.svg)](https://god.gw.postman.com/run-collection/58401244-916ddbda-1a70-4c07-8ccd-fe524703a84b?action=collection%2Ffork&source=rip_markdown&collection-url=entityId%3D58401244-916ddbda-1a70-4c07-8ccd-fe524703a84b%26entityType%3Dcollection%26workspaceId%3D8013472d-5897-47d1-bf5c-92683a027b35&utm_source=audiopod-docs-index)
...
<Columns cols={2}>
  ...
  <Card title="🎵 Stem Separation" href="/api-reference/stem-splitter">
    Isolate vocals, drums, bass, guitar from any song — or target one
    instrument from a 45-instrument catalog.
  </Card>
...
One rate card: an API call costs the same as the same job run from the
dashboard. $1 = 7,500 credits.

| Service | Rate |
|---------|------|
| Stem Separation | $0.088/min |
| Transcription | $0.0293/min |
| Voice Cloning/TTS | $66.67 per 1M characters |
| Voice Conversion | $0.132/min |
| Music Generation | $0.132/min |
| Speaker Separation | $0.044/min |
| Audiobook Narration | $66.67 per 1M characters |
| Media Conversion | $0.0088/min |
