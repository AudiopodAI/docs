...
Six requests in three folders. The first folder reaches a real `200` in two
...
folder 3 shows your wallet balance.
...
Every endpoint we support — 291 requests across 12 folders: text to speech and
voice design, transcription, music, audiobook, podcast, reader, stem separation,
speaker separation, noise removal, audio to MIDI, your wallet and your API keys.
Use it as a browsable reference once you know the shape of a call.
...
<Columns cols={2}>
  <Card title="Getting Started" icon="rocket" href="https://www.postman.com/rakesh-ad13f0db-3325695/audiopod/collection/58401244-916ddbda-1a70-4c07-8ccd-fe524703a84b?utm_source=audiopod-docs-postman">
    Six requests, keyless first call
  </Card>
  <Card title="AudioPod AI API" icon="code" href="https://www.postman.com/rakesh-ad13f0db-3325695/audiopod/collection/58401244-584f22a4-0bef-4783-92fc-4f62bc6df4c3?utm_source=audiopod-docs-postman">
    The full 291-request reference
  </Card>
</Columns>
...
<Columns cols={3}>
  ...
  <Card title="API pricing" icon="coins" href="https://www.audiopod.ai/developers/pricing">
    What a job costs, and the free starting credit
  </Card>
</Columns>
