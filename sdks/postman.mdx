...
folder 3 covers your wallet balance and registering a webhook so you can stop
polling altogether.
...
Every endpoint we support — 299 requests across 13 folders: text to speech and
voice design, transcription, music, audiobook, podcast, reader, stem separation,
speaker separation, noise removal, audio to MIDI, webhooks, your wallet and your
API keys.
...
<Columns cols={2}>
  ...
  <Card title="AudioPod AI API" icon="code" href="https://www.postman.com/rakesh-ad13f0db-3325695/audiopod/collection/58401244-584f22a4-0bef-4783-92fc-4f62bc6df4c3?utm_source=audiopod-docs-postman">
    The full 299-request reference
  </Card>
</Columns>
...
<Columns cols={3}>
  ...
  <Card title="Webhooks" icon="bell" href="/account/webhooks">
    One subscription, every job type — stop polling
  </Card>
</Columns>
