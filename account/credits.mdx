...
AudioPod AI uses multiple billing systems:
...
<Info>
**For API Access:** Developers using the API have a separate [API Wallet](/account/api-wallet) with USD-based pricing.
</Info>
...
<Columns cols={2}>
  ...
  <Card title="API Wallet" icon="wallet" href="/account/api-wallet">
    Developer billing with USD-based pricing.
  </Card>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Make your first API call.
  </Card>
  <Card title="API Reference" icon="code" href="/api-reference/credits-management">
